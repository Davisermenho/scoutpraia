...
FIELD_RELATIONSHIPS = (
    FieldRelationship("REL-GK-001", "CAMPOS_AUXILIARES_GOLEIRA", "goalkeeper_id", "entity_ref", "ATHLETES", "runtime_table", "athlete_id", "many_to_one", "selectbox", "Athlete", "INTEGER FK", "ATHLETES.athlete_id", False, "Obrigatório em goalkeeper_save, goalkeeper_goal_allowed e goalkeeper_specialist_exchange", "block_if event_code in [goalkeeper_save, goalkeeper_goal_allowed, goalkeeper_specialist_exchange] and empty", "CAMPOS_AUXILIARES_GOLEIRA + ATHLETES", "gerar selectbox de atleta; criar FK; nunca text_input", "goalkeeper_v1", "Identifica atleta em função de goleira no evento."),
