...
EVENT_DEFINITIONS = [
    ...
    },
    {
        ...
        "definition": "arremesso parado ou com até dois passos, sem mecanismo especial",
        "include_when": "finalização sem giro, sem voo e sem lance de 6m",
        "exclude_when": "spin_shot, inflight_shot, goalkeeper_shot ou six_metre_throw já identificados",
        "decision_rule": "usar como categoria base quando nenhum mecanismo especial é identificável",
        "evidence_type": "official_rule",
    },
    {
        ...
        "decision_rule": "se houver dúvida, registrar como simple_shot e revisar em vídeo",
        "evidence_type": "official_rule",
    },
    {
        "event_type": "inflight_shot",
        "definition": "finalização executada no ar, atleta recebe e arremessa antes de tocar o solo",
        "include_when": "finalização ocorre no ar após passe ou recepção",
        "exclude_when": "passe alto sem finalização ou finalização após contato com o solo",
        "decision_rule": "contar apenas quando há tentativa de finalização antes de tocar o solo",
        "evidence_type": "official_rule",
    },
    {
        "event_type": "goalkeeper_shot",
        "definition": "arremesso executado pela atleta no papel de goleira",
        "include_when": "goleira arremessa ao gol adversário como finalizadora",
        "exclude_when": "reposição ou passe da goleira sem intenção de finalizar",
        "decision_rule": "scorer_role obrigatório = goalkeeper",
        "evidence_type": "official_rule",
    },
    {
        "event_type": "six_metre_throw",
        "definition": "arremesso de 6 metros após infração grave na área de gol",
        "include_when": "lançamento de 6m concedido por árbitro",
        "exclude_when": "arremesso comum, shoot-out ou tiro de canto",
        "decision_rule": "usar somente quando o árbitro concede o lance de 6m",
        "evidence_type": "official_rule",
    },
    {
